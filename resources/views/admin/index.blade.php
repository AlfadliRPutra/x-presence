                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                <input type="text" name="name" id="name" class="form-control" placeholder="Nama intern" value="{{ request('name') }}">
                                            </div>
                                        </div>
                                        <div class="col-2">
                                            <div class="form-group">
                                ...
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($intern as $k)
                                            ...
                                            @endphp
                                            <tr>
                                                <td>{{ $loop->iteration + $intern->firstItem() -1 }}</td>
                                                <td>{{ $k->nik }}</td>
                                                <td>{{ $k->name }}</td>
                                                <td>{{ $k->email }}</td>
                                                <td>{{ $k->role }}</td>
...
<div class="modal modal-blur fade" id="modal-inputintern" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title">Tambah Data intern</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <form action="/intern/store" method="POST" id="frmintern">
                @csrf
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="text" id="name" class="form-control" name="name" placeholder="Nama Lengkap intern">
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="input-icon mb-3">
                            ...
                            <input type="tel" name="no_hp" id="no_hp" class="form-control" placeholder="No Handphone Aktif intern">
                        </div>
                    </div>
                </div>
...
<script>
    $(function(){
        $("#btnTambahintern").click(function(){
            $("#modal-inputintern").modal("show");
        });
