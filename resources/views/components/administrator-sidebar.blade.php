    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
      <div class="sidebar-content">
        <ul class="nav nav-secondary">
          ...
          <li class="nav-item {{ request()->is('admin/home') ? 'active' : 'inactive' }}">
          ...
          {{-- <li class="nav-item {{ request()->is('admin/document') ? 'active' : 'inactive' }}">
            <a href="{{ route('admin.document') }}" class="collapsed" aria-expanded="false">
          ...
          {{-- <li class="nav-item {{ request()->is('admin/setting') ? 'active' : 'inactive' }}">
            <a href="{{ route('admin.setting') }}" class="collapsed" aria-expanded="false">
          ...
          {{-- <li class="nav-item {{ request()->is('admin/help') ? 'active' : 'inactive' }}">
            <a  href="{{ route('admin.help') }}" class="collapsed" aria-expanded="false">
