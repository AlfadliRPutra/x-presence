    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                <li class="nav-item {{ request()->is('dashboard-admin') ? 'active' : 'inactive' }}">
                ...
                <li class="nav-item {{ request()->is('intern') ? 'active' : 'inactive' }}">
                ...
                <li class="nav-item {{ Route::is('today', 'riwayat', 'rekap') ? 'active' : 'inactive' }} submenu">
                ...
                {{--
                <li
                    class="nav-item {{ request()->is('admin/document') ? 'active' : 'inactive' }}"
                >
                    <a
                ...
                {{--
                <li
                    class="nav-item {{ request()->is('admin/setting') ? 'active' : 'inactive' }}"
                >
                    <a
                ...
                --}} {{--
                <li
                    class="nav-item {{ request()->is('admin/help') ? 'active' : 'inactive' }}"
                >
                    <a
